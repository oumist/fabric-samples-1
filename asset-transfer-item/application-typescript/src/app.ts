...
async function main() {
    try {
        ...
        try {
            ...
            console.log('\n--> Submit Transaction: CreateItem, function creates the initial set of assets on the ledger');
            await contract.submitTransaction('CreateItem','item1','movie', 'Wolf of wall street', 'Ali', '26-7','13', 'true');
            console.log('*** Result: committed');

            // Let's try a query type operation (function).
            // This will be sent to just one peer and the results will be shown.
            console.log('\n--> Evaluate Transaction: GetAllItems, function returns all the current assets on the ledger');
